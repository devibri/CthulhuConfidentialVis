...
html_file = open("scene_dame.html", "w")
with open("scene_dame.yaml", "r") as ymlfile:
    yaml_file = yaml.safe_load(ymlfile)

# adds the beginning for HTML page and table
html_file.write('<head><link rel="stylesheet" href="style.css"><link href="https://fonts.googleapis.com/css2?family=Zen+Kaku+Gothic+Antique:wght@300;400;500;700;900&display=swap" rel="stylesheet"></head>\n')
